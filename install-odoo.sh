...
echo -e "\n---- Install Aeroo Reports Odoo Modules: ----"
        ...
        sudo su $OE_USER -c "git clone -b 8.0 https://github.com/aaltinisik/product-attribute.git"
        sudo su $OE_USER -c "git clone -b 8.0 https://github.com/aaltinisik/sale-workflow.git"
        sudo su $OE_USER -c "git clone -b 8.0 https://github.com/aaltinisik/account-invoicing.git"
        sudo su $OE_USER -c "git clone -b 8.0 https://github.com/aaltinisik/stock-logistics-tracking.git"
...
OCA_HOME="$OE_HOME/OCA"
        ...
        sudo su $OE_USER -c "git clone -b $OE_VERSION https://github.com/aaltinisik/web.git $OCA_HOME/web"
        sudo su $OE_USER -c "git clone -b $OE_VERSION https://github.com/yelizariev/addons-yelizariev.git $OCA_HOME/addons-yelizariev"
        sudo su $OE_USER -c "git clone -b $OE_VERSION https://github.com/aaltinisik/server-tools.git $OCA_HOME/server-tools"
        sudo su $OE_USER -c "git clone -b $OE_VERSION https://github.com/aaltinisik/knowledge.git $OCA_HOME/knowledge"
        sudo su $OE_USER -c "git clone -b $OE_VERSION https://github.com/aaltinisik/purchase-workflow.git $OCA_HOME/purchase-workflow"
        sudo su $OE_USER -c "git clone -b $OE_VERSION https://github.com/aaltinisik/product-attribute.git $OCA_HOME/product-attribute"
        sudo su $OE_USER -c "git clone -b $OE_VERSION https://github.com/aaltinisik/sale-workflow.git $OCA_HOME/sale-workflow"
        sudo su $OE_USER -c "git clone -b $OE_VERSION https://github.com/aaltinisik/account-invoicing.git $OCA_HOME/account-invoicing"
        sudo su $OE_USER -c "git clone -b $OE_VERSION https://github.com/aaltinisik/stock-logistics-tracking.git $OCA_HOME/stock-logistics-tracking"
        sudo su $OE_USER -c "git clone -b $OE_VERSION https://github.com/aaltinisik/partner-contact.git $OCA_HOME/partner-contact"
