odoo.define('altinkaya_ecommerce.s_dynamic_category_table_options', function (require) {
'use strict';
...
const dynamicSnippetCategoryTableOptions = s_dynamic_snippet_carousel_options.extend({
...
options.registry.dynamic_category_table = dynamicSnippetCategoryTableOptions;

return dynamicSnippetCategoryTableOptions;
});
