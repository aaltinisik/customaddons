...
class ProductProduct(models.Model):
    ...
    is_published = fields.Boolean(
        ...
        default=lambda self: self.product_tmpl_id.is_published,
    )
    ...
    public_description = fields.Html(
        ...
        copy=False,
        default=lambda self: self.product_tmpl_id.public_description,
    )
    ...
    def name_get(self):
        ...
        for product in self.sudo():
            ...
            variable_attributes = ptal.filtered(
                lambda p: p.default_value_id not in product.attribute_value_ids
            ).mapped("attribute_id")
