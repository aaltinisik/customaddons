...
class AccountInvoiceReport(models.Model):
    ...
    def _select(self):
        return super(AccountInvoiceReport, self)._select() + \
               ", sub.state_id, sub.price_total_usd as price_total_usd, sub.price_average_usd as price_average_usd, sub.source_id as source_id, sub.campaign_id as campaign_id"
    ...
    def _group_by(self):
        return super(AccountInvoiceReport, self)._group_by() + ", coalesce(partner.state_id, partner_ai.state_id),partner.source_id,partner.campaign_id"
